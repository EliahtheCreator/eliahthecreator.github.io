...
const profile = {
  ...
  experiences: {
    ...
    vast:
      "在 VAST，Eliah 对接增长业务社招和实习共 30 个岗位，其中实习岗位独立负责 14 个、社招岗位协助 mentor 16 个，覆盖设计、策略优化、投放执行、增长工程等业务。8 月份共推送简历 204 份，评估通过 166 份，通过率 81.4%；通过自主 Sourcing 产出 offer 14 份并全部接受，其中 8 人已入职，6 人待入职，8 月高分候选人数位列组内第1名。他也使用 Agent 搭建招聘数据漏斗，搭建小语种本土化口语测试 bot，并持续维护招聘台账和工作日志。",
    kuaishou:
      "在快手 · 可灵 AI，Eliah 对接多模态理解与生成一体化算法岗，负责实习生 HR 面试。那段时间校招 + 实习推送简历 200+，通过率 70% 以上；组织面试 323 场；发送 offer 16 人，接受 offer 12 人。他也做过 Google Scholar、OpenReview、AMiner、脉脉等渠道的竞家 Mapping，支持 AI Infra、AI Agent、具身智能、大模型数据策略等方向，并负责校招竞家薪酬方案收集、候选人入职信息录入与流程跟进。",
    gaotu:
  ...
  projects: [
    ...
    "Codex-Doubao 编排式简历评估与录入 Skill：Codex 负责评估分级与报告生成，豆包负责简历读取和台账录入。",
    "3D Mapping Skill：通过 Google Scholar、LinkedIn、GitHub 等公开渠道，寻找 3D 生成相关经验的高年级博士候选人。",
    "全岗位面试资料库（在建）：纯演示 Demo，整理全类型岗位的常见问题优秀解答、风险点与大厂 JD 解析。",
  ],
  hobbies: ["摄影", "绘画", "旅行", "足球"],
  dailyLife: {
